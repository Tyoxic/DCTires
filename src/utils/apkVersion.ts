...
const RELEASES_API = 'https://api.github.com/repos/Tyoxic/DCTires/releases/latest';
const RELEASES_URL = 'https://github.com/Tyoxic/DCTires/releases/latest';
...
export const RELEASES_PAGE_URL = RELEASES_URL;
